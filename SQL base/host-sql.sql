...
-- Дамп данных таблицы podarok.category: ~1 rows (приблизительно)
...
-- Дамп данных таблицы podarok.image: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `image` DISABLE KEYS */;
INSERT INTO `image` (`id`, `id_p`, `osn`) VALUES
	(23, 54, 1);
...
-- Дамп данных таблицы podarok.order: ~0 rows (приблизительно)
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='id_sr- статистика продукта';

-- Дамп данных таблицы podarok.product: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `product` DISABLE KEYS */;
INSERT INTO `product` (`id`, `name`, `id_sr`, `id_s`, `price`, `description`, `count`) VALUES
	(54, ' q', 0, 14, 1, ' Т<br>\r\n    ут типа описание товара ЛОЛ.', 1);
...
-- Дамп данных таблицы podarok.s_category: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `s_category` DISABLE KEYS */;
INSERT INTO `s_category` (`id`, `name`, `id_c`) VALUES
	(14, 'Наручные', 12);
